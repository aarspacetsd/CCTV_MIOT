...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            {{-- Menggunakan route user.camera-groups.index agar URL menjadi /dashboard/user/camera-groups --}}
            <a href="{{ route('user.camera-groups.index') }}" class="btn btn-outline-primary">
